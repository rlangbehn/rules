/*****************************************************************************
 * $Id: Main.java 559 2010-05-27 10:44:41Z rlangbehn $
 *
...
import net.sourceforge.rules.compiler.drools.util.FatalError;
...
public class Main
{
			...
			new HiddenOption("sourcefile") { //$NON-NLS-1$
				...
				boolean matches(String s) {
					...
					return s.endsWith(".brl")  || //$NON-NLS-1$
					       ...
					       s.endsWith(".dsl")  || //$NON-NLS-1$
					       s.endsWith(".dslr") || //$NON-NLS-1$
					       s.endsWith(".rf")   || //$NON-NLS-1$
	...
	private static final String DROOLSC_RB = "net.sourceforge.rules.compiler.drools.droolsc"; //$NON-NLS-1$
