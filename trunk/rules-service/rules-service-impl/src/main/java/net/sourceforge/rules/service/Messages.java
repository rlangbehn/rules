/*****************************************************************************
 * $Id: Messages.java 166 2008-08-01 14:28:40Z rlangbehn $
 *
...
public final class Messages
{
	...
	private static final String BUNDLE_NAME =
		"net.sourceforge.rules.service.messages"; //$NON-NLS-1$
	...
	public static String getError(String key) {
		String s = "net.sourceforge.rules.service.error." + key; //$NON-NLS-1$
		return getString(s);
	}
	...
	public static String getInfo(String key) {
		String s = "net.sourceforge.rules.service.info." + key; //$NON-NLS-1$
		return getString(s);
	}
	...
	public static String getWarning(String key) {
		String s = "net.sourceforge.rules.service.warning." + key; //$NON-NLS-1$
		return getString(s);
	}
