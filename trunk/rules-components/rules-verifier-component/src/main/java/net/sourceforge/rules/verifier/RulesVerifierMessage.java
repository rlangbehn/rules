 ...
 */
public class RulesVerifierMessage
{
	/**
	 ...
	 * @param message The actual error text produced by the language processor
	 */
	public RulesVerifierMessage(String message) {
		this.message = message;
	}
	 ...
	 */
	public RulesVerifierMessage(String message, boolean error) {
		this.message = message;
		this.error = error;
	}
